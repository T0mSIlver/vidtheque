...
import { BOOTH_QUESTION } from "./data/show";
import { BoothLog } from "./BoothLog";
...
// every figure comes from ./data/corpus, and the page fetches nothing. The
// markup lives here rather than in the route file, which shares this kit's
// stylesheet and would otherwise reach into it.
